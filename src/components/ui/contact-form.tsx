  ...
  return (
    <Form {...form}>
      ...
      >
              ...
              return (
                <FormItem className="flex flex-row md:items-center gap-4">
                  ...
                  <FormLabel className="font-normal font-albert-sans leading-5 sm:leading-4">
                    ...
                    travel inspiration from Ar Rahah. (Optional for
                    mailing list signup)
                  </FormLabel>
                </FormItem>
              );
        ...
        <Button
          className="h-fit w-full md:w-fit font-inter-tight font-semibold text-base rounded-full py-3 lg:py-4 md:!px-6 cursor-pointer transition-transform duration-300 hover:scale-105"
          type="submit"
        >
