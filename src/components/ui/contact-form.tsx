...
const DEFAULT_MAP = "http://purecatamphetamine.github.io/country-flag-icons/3x2/US.svg";
...
export default function ContactForm() {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="w-full space-y-15 lg:space-y-20">
                <div className='w-full space-y-8'>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    ...
                                    <FormControl>
                                        <Input className={inputClassName} placeholder="Enter your full name..." {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    ...
                                    <FormControl>
                                        <Input className={inputClassName} placeholder="Enter your email address..." {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                    ...
                    <div className="space-y-2">
                        <FormLabel className={formLabelClassName}>Phone Number*</FormLabel>
                        <div className="flex flex-row gap-4">
                                                            ...
                                                            {countryCodes.map((country) => (
                                                                ...
                                                                >
                                                                    <div className="size-8 overflow-hidden rounded-full">
                                                                        <img className="aspect-square object-cover" src={country.svgSrc} />
                                                                    </div>
                                                                    {country.dialCode}
                                                                    <Check
                                                                        className={cn(
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="w-full">
                                        <FormControl>
                                            <Input className={inputClassName} placeholder="Enter your phone number..." {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                <FormLabel className={formLabelClassName}>Address</FormLabel>
                                <FormControl>
                                    <Input className={inputClassName} placeholder="Enter your full address..." {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem >
                                <FormLabel className={formLabelClassName}>Best Time to Contact You</FormLabel>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className={formLabelClassName}>Your Message (Optional)</FormLabel>
                                <FormControl>
                                    <Textarea
