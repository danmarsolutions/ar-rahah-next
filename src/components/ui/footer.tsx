        ...
        <footer className="w-full flex flex-col md:p-4 font-albert-sans">
            <div className="w-full grid grid-cols-1 lg:grid-cols-[auto_1fr] auto-rows-auto lg:grid-rows-[auto_auto] lg:grid-flow-col gap-y-10 xl:gap-y-20 py-15 2xl:py-20 px-8 lg:px-10 2xl:px-15 md:rounded-4xl bg-black text-white">
                ...
                <div className="grow 2xl:max-w-[864px] flex flex-col gap-8">
                    <h2 className="font-inter-tight text-3xl md:text-5xl lg:text-5xl font-semibold leading-tight">Pack your bags — your spiritual journey awaits!</h2>
                ...
                <div className="w-full lg:max-w-[620px] flex flex-col md:flex-row lg:flex-wrap xl:flex-row gap-y-10">
                    <div className="w-full md:max-w-[180px] flex flex-col gap-6 2xl:gap-8">
                        ...
                        <div className="flex flex-col gap-2 text-white/50 text-lg">
                            <Link className="cursor-pointer hover:underline" href='/#destinations'>Destinations</Link>
                            <Link className="cursor-pointer hover:underline" href='/#topTours'>Top Tours</Link>
                    ...
                    <div className="w-full md:max-w-[180px] flex flex-col gap-6 2xl:gap-8">
                        ...
                        <div className="flex flex-col gap-2 text-white/50 text-lg">
                            ...
                            <Link className="cursor-pointer hover:underline" href='/#testimonials'>Testimonials</Link>
                ...
                {/* Book Button */}
                <ButtonLink href='/package' className="bg-white text-black row-start-2 md:col-start-1 lg:col-start-2 md:row-start-2 md:row-end-3 lg:row-start-1 lg:row-end-2 justify-self-end">
                    Book a Vacation
