...
export default function Home() {
  return (
    <main className='w-full flex flex-col'>
        ...
        <div className='w-full h-fit lg:max-w-[456px] 2xl:max-w-[646px] flex flex-col gap-8 xl:gap-14'>
          <div className='flex flex-col gap-8'>
            ...
            <div className='flex flex-col lg:flex-row gap-8 md:gap-4 font-albert-sans text-base'>
              <div className='flex flex-row items-center gap-2'><MapPin /> Turkey</div>
              <div className='flex flex-row items-center gap-2'><CalendarDays /> Oct 15, 2025 - Oct 24, 2025</div>
            </div>
          </div>
          <div className='w-full flex flex-row items-center justify-between gap-4 max-w-xl'>
            <div className='w-fit flex flex-col gap-2 font-albert-sans text-base'>
              ...
              <div className='text-2xl sm:text-3xl xl:text-3xl'>$9,000</div>
              <div className='whitespace-nowrap'>Per Person</div>
            </div>
            <div className='border border-black w-full h-0'></div>
            <div className='w-fit flex flex-col gap-2 font-albert-sans text-base'>
              <div>To</div>
              <div className='text-2xl sm:text-3xl xl:text-3xl'>$19,000</div>
              <div className='whitespace-nowrap'>Per Person</div>
            </div>
          </div>
      ...
      {/* Spirtual Adventure */}
      <section id='topTours' className='bg-[#F7F7F7] flex flex-col w-full items-center gap-20 p-4 sm:p-12 xl:p-24 2xl:p-32'>
        <div className='flex flex-col items-center gap-6'>
          <div className='bg-[#EFEFEF] w-fit font-inter-tight py-3 px-5 rounded-full'>Spirtual Adventure</div>
          <h2 className='font-inter-tight font-semibold text-[32px] text-center leading-none lg:text-left lg:text-5xl'>Top Tours to Spark Your Wanderlust</h2>
      ...
      {/* Our Destinations */}
      <section id='destinations' className='w-full flex flex-col gap-10 xl:gap-20 p-4 py-14 sm:p-12 xl:p-24 2xl:p-32'>
        <div className='flex flex-col lg:flex-row justify-between gap-6 lg:gap-16 xl:gap-32'>
          <div className='flex flex-col items-center lg:items-start gap-8 lg:gap-4'>
            ...
            <h2 className='font-inter-tight font-semibold text-[32px] text-center leading-none lg:text-left lg:text-5xl'>Your next favorite place awaits</h2>
          </div>
      ...
      <section className='w-full flex flex-col gap-10 xl:gap-20 bg-[#F7F7F7] p-4 py-14 sm:p-12 xl:p-24 2xl:p-32'>
        <div className='flex flex-col lg:flex-row justify-between '>
          <div className='flex flex-col items-center lg:items-start gap-8'>
            ...
            <h2 className='font-inter-tight font-semibold text-[32px] text-center lg:text-left lg:text-5xl'>What&apos;s so special about this?</h2>
          </div>
          <ButtonLink href='/about-us' className='hidden lg:flex place-self-end'>
            Learn more
            <img className='w-[1.75em] h-fit' src='/icons/triple-chevron.svg' />
          </ButtonLink>
        </div>
      ...
      {/* Testimonials */}
      <section id='testimonials' className='w-full aspect-video flex flex-col justify-center  items-center gap-8 p-4 py-14 sm:p-12 xl:p-24 2xl:p-32'>
        <div className='flex flex-col items-center gap-4'>
          <div className='bg-[#EFEFEF] w-fit font-inter-tight py-3 px-5 rounded-full'>Loyalty Speaks</div>
          <h2 className='font-inter-tight font-semibold text-[32px] lg:text-5xl'>Testimonials</h2>
        </div>
        <Testimonials />
      </section>
    </main>
